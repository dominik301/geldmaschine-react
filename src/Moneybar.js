...
const MoneyBar = ({players, bank, staat}) => {
      ...
      <div id="moneybar">
        <table>
            ...
            {players.map((player, index) => (
                <tr key={index} id={`moneybarrow${index + 1}`} className="money-bar-row">
          ...
          <tr id="moneybarrow7" className="money-bar-row">
            ...
            <td id="p7moneybar" className="moneybarcell">
              ...
              <div>Geldmenge: <span id="p7money">{bank.geldMenge}</span></div>
              <div>Zinsen: <span id="p7credit">{bank.zinsenLotto}</span></div>
              <div>Anleihen: <span id="p7anleihen" className="player-anleihen">{bank.anleihen}</span></div>
              <div>Derivate: <span id="p7derivate" className="player-derivate">{bank.derivate}</span></div>
            </td>
          </tr>
          <tr id="moneybarrow8" className="money-bar-row">
            ...
            <td id="p8moneybar" className="moneybarcell">
              ...
              <div>Staatsschuld: <span id="p8money" className="player-credit">{staat.staatsSchuld}</span></div>
              <div>Steuer: <span id="p8credit">{staat.steuer}</span></div>
            </td>
          </tr>
          </tbody>
        </table>
